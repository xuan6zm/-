...
立交付与落地能力强； <br>
3.精通 SIP、PJSIP、WebRTC、VoIP 音视频 开发与优化 <br>
4.熟练掌握 GCD、多线程、内存 / 性能优化，问题排查能力突出，可快速定位线上崩溃、卡顿、兼容性等疑难问题； <br>
5.熟练使用 Charles、Wireshark、Postman 等工具进行网络调试，精通 CocoaPods、Git 等工程化工具； <br>
6.具备完整 App 上架、审核跟进、证书配置、版本迭代及线上问题处理经验。 <br>
7.熟练运用 KVO、KVC、单例模式、Block、通知机制、观察者模式 等 iOS 核心编程思想，日常开发实践经验扎实。 <br>
8.熟悉 RunTIme 和 RunLoop 的底层原理，能够运用其进行复杂逻辑实现 <br>
9.熟练使用 IJKPlayer 实现视频播放、倍速 / 硬解 / 兼容性优化 <br>
10.熟悉科大讯飞 ASR 语音识别与声网（Agora）音视频 SDK，可集成实现语音转文字、实时音视频通话功能 <br>
